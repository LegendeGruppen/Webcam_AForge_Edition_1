...
namespace Webcam_AForge_Edition
{
    public partial class Form1 : Form
    {
        ...
        internal GlobalVars gv; // Instatiate Global var

        public Form1()
        {
            InitializeComponent();
            buttonCamStart.Enabled = false;
            gv = new GlobalVars(); // Inilializes Global var
        }
        
        /**************************************************************************************/
        // Loads form1, creates Videocapturedevices that gets all capture devices (cameras)
        /**************************************************************************************/
        ...
        /**************************************************************************************/
        // Closes and ends all camera actions
        /**************************************************************************************/
        ...
        private void buttonCamStart_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == dr)
            {
                ...
                //Gets videoresolution possibilities

                VideoCapabilities[] vc = gv.FinalVideo.VideoCapabilities;

                //Get selvected resolution
        ...
        private void buttonGrayscale_Click(object sender, EventArgs e)
        {
            try
            {
                // pushes current captured image to stack and makes a new copy
